...
app = Flask(__name__, template_folder='')  # Setting template_folder to root
...
@app.route('/signin')
def signin():
    return render_template('templates/signin.html')  # Specify path if not in root
...
def image_to_text():
    ...
    return render_template('templates/image-text.html')

# Route to render the PDF-to-Word converter page
@app.route('/pdf-to-word')
def pdf_to_word():
    return render_template('templates/pdf_to_word.html')

# Route to render the PPT-to-PDF converter page
@app.route('/ppt-to-pdf')
def ppt_to_pdf():
    return render_template('templates/ppt_to_pdf.html')

# Route to render the Text-to-PDF converter page
@app.route('/text-to-pdf')
def text_to_pdf():
    return render_template('templates/text_to_pdf.html')

# Route to render the Word-to-PDF converter page
@app.route('/word-to-pdf')
def word_to_pdf():
    return render_template('templates/word_to_pdf.html')
